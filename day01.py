...
print("7号     牛仔裤       66.3     600          72  ")
print("8号     羽绒服       253.6    500          69")
print("9号     牛仔裤       86.3     600          72")
print("10号    羽绒服       253.6    500          69")
print("11号    牛仔裤       86.3     600          72")
...
print("12月份销售总金额",253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.3*68+96.8*78)
print("羽绒服销售占比",253.6*239/198695.6)
print("牛仔裤销售占比",86.3*517/198695.6)
print("风衣销售占比",96.8*292/198695.6)
print("皮草销售占比",135.9*207/198695.6)
print("T恤销售占比",65.8*469/198695.6)
print("衬衫销售占比",49.3*120/198695.6)
